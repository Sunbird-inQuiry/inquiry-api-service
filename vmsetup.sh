...
mvn verify sonar:sonar -Dsonar.projectKey=Sunbird-inQuiry_inquiry-api-service -Dsonar.organization=sunbird-inquiry -Dsonar.host.url=https://sonarcloud.io -Dsonar.coverage.exclusions=**/CustomProblemHandler.java -Dsonar.scala.coverage.reportPaths=/home/circleci/project/assessment-api/assessment-service/target/scoverage.xml,/home/circleci/project/assessment-api/assessment-actors/target/scoverage.xml,/home/circleci/project/assessment-api/qs-hierarchy-manager/target/scoverage.xml,/home/circleci/project/target/scoverage.xml
